...
export function Editor({
  ...
  const stdinLocked = !!challenge && !challenge.kidStdin;
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setSubmitMsg(null);
    try {
      const res = await submitChain(
        challenge.id,
        flowchart,
        challenge.kidStdin ? stdinInput : undefined,
      );
      setSubmitMsg(res);
    } catch (e) {
      setSubmitMsg({
  ...
  }, [challenge, flowchart, stdinInput]);
    ...
    <div className="main">
          ...
          <div className={`challenge-panel${promptOpen ? "" : " collapsed"}`}>
            ...
            {promptOpen && (
              <>
                ...
                {typeof challenge.maxBlocks === "number" && (
                  <div className="allowed-hint">
                    chain limit: at most {challenge.maxBlocks} blocks on the canvas
                  </div>
                )}
      ...
      <div className="sidepanel">
        ...
        <ConsoleView
          ...
          defaultHex={!!challenge?.kidStdin}
          blacklistedBytes={challenge?.kidStdin ? challenge.blacklistedBytes : undefined}
        />
      </div>
    </div>
  );
